[CmdletBinding()]
param([int]$Port = 8546, [int]$ChainId = 143, [string]$HostAddr = '127.0.0.1')
$ErrorActionPreference = 'Stop'
Write-Host "=== LOCAL ANVIL WITH CHAIN ID 143 ===" -ForegroundColor Yellow
Write-Host "NOT MONAD MAINNET. NOT MONAD TESTNET." -ForegroundColor Yellow
Write-Host "Chain: $ChainId  Port: $Port" -ForegroundColor Yellow
...
Write-Host "Starting Anvil (chain $ChainId) on ${HostAddr}:${Port}..."
...
Write-Host "LOCAL ANVIL WITH CHAIN ID 143. NOT MONAD." -ForegroundColor Yellow
